"""Preview overall background dimming at a few levels, on the tweak4 layout."""
import os
...
def render(alpha, name):
    ...
    img.save(os.path.join(OUT_DIR,name)); img.save(os.path.join(ROOT,name))

render(0,   "dim-00.png")   # none (current)
render(64,  "dim-25.png")   # 0.25
render(102, "dim-40.png")   # 0.40
print("done")
